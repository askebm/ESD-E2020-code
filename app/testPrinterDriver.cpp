...
int main() {
    ...
    dev_handle = libusb_open_device_with_vid_pid(ctx, 1046, 20497); //these are vendorID and productID I found for my usb device
	if(dev_handle == NULL)		
	...
	data[0]='P'; data[1] = 'E'; data[2] = 'N'; data[3] = 'I'; data[4] = 'S'; data[5] = 0xA;  //some dummy values
